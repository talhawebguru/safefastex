...
const ServiceCTA = ({ heading, subheading, buttonText, buttonHref }) => {
  return (
    <section className="relative overflow-hidden py-16 sm:py-20 lg:py-28 bg-brand text-white">
      ...
      <Container>
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            <Link
              href={buttonHref}
              className="group relative inline-flex items-center rounded-2xl border border-gray-900 text-white pl-6 pr-1 py-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#39C0C8]/60"
            >
              <span
                aria-hidden
              ...
              <span className="relative z-10 ml-3 inline-flex h-10 w-10 items-center justify-center rounded-xl transition-bg duration-500 bg-gray-900 group-hover:bg-brand text-white">
