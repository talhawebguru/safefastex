    ...
    >
      ...
      <Container>
        <div className="relative z-10 min-h-screen flex items-center">
          <div className="w-full grid lg:grid-cols-2 gap-12 lg:gap-16 items-start py-16 lg:py-24">
            ...
            <motion.div
              ...
              className="bg-white rounded-[25px] p-8 lg:p-12 border border-gray-300 max-w-2xl"
            >
              ...
              <form className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="relative">
                    <input
                      ...
                      className="w-full h-12 px-4 border border-gray-300 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:border-gray-900 focus:outline-none transition-colors"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="relative">
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full h-12 px-4 border border-gray-900 rounded-lg text-sm text-gray-900 bg-white focus:border-gray-900 focus:outline-none transition-colors appearance-none cursor-pointer"
                    >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-4">
                    <label className="flex items-center space-x-3 cursor-pointer">
                      ...
                      />
                      <span className="text-gray-700 text-base">Fragile</span>
                    </label>
                    <label className="flex items-center space-x-3 cursor-pointer">
                      <input
                        type="checkbox"
                        ...
                        className="w-5 h-5 border border-gray-300 rounded text-gray-900 focus:ring-0"
                      />
                      <span className="text-gray-700 text-base">Express</span>
                    </label>
                  </div>
                  <div className="space-y-4">
                    <label className="flex items-center space-x-3 cursor-pointer">
                      ...
                      />
                      <span className="text-gray-700 text-base">Insurance</span>
                    </label>
                    <label className="flex items-center space-x-3 cursor-pointer">
                      <input
                        type="radio"
                        ...
                        className="w-4 h-4 border border-gray-300 text-gray-900 focus:ring-0"
                      />
                      <span className="text-gray-700 text-base">Packaging</span>
                    </label>
                  </div>
                </div>
                ...
                >
                  <Link
                    href="/about-us"
                    className="group relative inline-flex items-center rounded-2xl border border-amber-300 text-black pl-6 pr-1 py-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/60"
                  >
                    <span
                      aria-hidden
            ...
            <div className="lg:pl-8 space-y-8">
              ...
              >
                ...
                <div className="mb-8">
                  <div className="px-2 py-1 text-6xl font-semibold flex flex-wrap gap-2">
                    Provide quick Tracking your cargo
                  </div>
                </div>

                <p className="text-white text-base leading-8 max-w-lg">
              ...
              <motion.div
                ...
                className="bg-amber-400 rounded-[25px] p-8 lg:p-12 max-w-2xl"
              >
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                  <div>
                    <h3 className="text-gray-900 text-3xl font-semibold leading-10 mb-2">
                      Do you have
                      <br />
                      any questions?
                    </h3>
